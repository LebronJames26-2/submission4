...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <br></br><br></br>
      <Image src="https://drive.google.com/thumbnail?id=1Zbi643T8LOtooodmUuUOHSf51ss0kpJ9&sz=w1000" width={500} alt=""/> 
      ...
      <br></br>
      <Image src="https://drive.google.com/thumbnail?id=1pwaqWQBLasuMRaTE_uDanhQz0OjChVY7&sz=w1000" width={500} alt=""/> 
      <br></br>
      ...
      <br></br>
      <Image src="https://drive.google.com/thumbnail?id=1DKg2MaQGWUgVPoyYB-wTvSyN6lJ2lDOh&sz=w1000" width={500} alt=""/> 
      <br></br>
      ...
      <br></br>
      <Image src="https://drive.google.com/thumbnail?id=1FfywK22tDsJlYFswOG0XeAAzQh0OWzgL&sz=w1000" width={500} alt=""/> 
      <br></br>
